...
app = InstagramJsonClient()
tutti_i_post = app.get_by_hashtag("milanofashionweek", count=3)
codici = [post.code for post in tutti_i_post]
pprint(app.get_by_media_codes(codici, all_comments=False))
